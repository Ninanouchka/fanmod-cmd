...
//wxMessageBox(wxString("  ex: ") << eu << " " << ev << " " << fu << " " << fv << " " << et << " " << ft, "Error reading file", wxICON_ERROR | wxOK);
...
//wxMessageBox(wxString("  after: ") << edge_get_u(new_e) << " " << edge_get_v(new_e) << " " << edge_get_u(new_f) << " " << edge_get_v(new_f) << " " << new_et << " " << new_ft, "Error reading file", wxICON_ERROR | wxOK);
